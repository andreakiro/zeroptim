...
class VisionDataset:
    ...
    def make_loader(
        ...
        **kwargs # more specific parameters
        ...
        transform = VisionDataset.get_transform(dataset_name, split, use_transform=use_transform)
        ...
        if dataset_name == 'mnist-digits' and 'digits' in kwargs:
            ...
            indices = [i for i, (_, label) in enumerate(dataset) if label in kwargs['digits']]
